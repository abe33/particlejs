(function() {
  ...
  $(document).ready(function() {
    ...
    return canvas.click(function(e) {
      ...
      return system.emit(new particlejs.Emission(particlejs.Particle, new particlejs.Ponctual(new geomjs.Point(x, y)), new particlejs.Unlimited(), new particlejs.ByRate(10), new particlejs.Explosion(10, 20)));
    });
  });
